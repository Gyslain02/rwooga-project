...
const App: React.FC = () => {
  ...
  const { isCustomPrintingEnabled } = useSelector((state: RootState) => state.settings);
  ...
  const togglePrinting = (val: boolean) => {
    dispatch(setPrintingEnabled(val));
  };
  ...
  return (
    <Router>
      ...
      <AppContent
        ...
        isCustomPrintingEnabled={isCustomPrintingEnabled}
...
const WhatsAppButton: React.FC = () => {
  ...
  const hidePaths = ['/login', '/signup', '/admin'];
...
const AppContent: React.FC<{
  ...
  togglePrinting: (val: boolean) => void;
